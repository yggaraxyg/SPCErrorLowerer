...
if (len(sys.argv)!=11):
    print("ten arguments please! (laser illumination, background illumination, start of attenuation multiplier, end of attenuation multiplier, interval of attenuation, max distance, repetitions of each value, histogram bins, and pulses)")
    exit(-1)
