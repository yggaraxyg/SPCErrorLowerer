...
from SPCSim.sensors.dtof import HEDHBaseClass
...
N_edhbins = 16 # Number of EDH bins
N_pulses = 1200 # Number of laser pulses
...
PixLdr = PerPixelLoader(min_dist = 0.1,
                        max_dist = 0.8,
                        num_dists= 10,
                        tmax = 100,
                        num_runs=sims,
...
spc1 = HEDHBaseClass(PixLdr.Nr,
              ...
              step_params={
                  "k":1, # Step size gain
                  "step_vals": [4, 2, 1], # List of decaying/reducing step size values per binner
              })
