...
if (len(sys.argv)<5):
    print("Reverse (0,1), Same y (0,1), dist and fwhm (for labeling purposes), and Filename(s) please!")
    exit(-1)
...
box.suptitle("Effect of optical attenuation for distance fraction "+dist+", phi_sig: 1, phi_bkg: 4, FWHM: "+FWHM+".", fontsize=24)
#plt.figure(figsize=(12,4))
if(samey):
    samstring = "Sharedy"
else:
    samstring = "Zoomedy"
plt.savefig("5FWHMGraphs/dist-"+str("point".join(dist.rsplit(".")))+"-"+samstring+".png")
print(dist+" done.")
#plt.show()
