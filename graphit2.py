...
if (len(sys.argv)<5):
    print("Dep/Width (0,1), Same y (0,1), dist and fwhm (for labeling purposes), and Filename(s) please!")
    exit(-1)
...
plt.savefig(str("Graphs/FWHM-"+str(FWHM)+"-dist-"+str("point".join(dist.rsplit(".")))+"-"+samstring+"-"+labStr+".png")
print(dist+" done.")
#plt.show()
